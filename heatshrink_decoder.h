...
extern "C" heatshrink_decoder *heatshrink_decoder_alloc(uint16_t input_buffer_size,
    uint8_t expansion_buffer_sz2, uint8_t lookahead_sz2);

/* Free a decoder. */
extern "C" void heatshrink_decoder_free(heatshrink_decoder *hsd);
#endif

/* Reset a decoder. */
extern "C" void heatshrink_decoder_reset(heatshrink_decoder *hsd);
...
extern "C" HSD_sink_res heatshrink_decoder_sink(heatshrink_decoder *hsd,
    uint8_t *in_buf, size_t size, size_t *input_size);

/* Poll for output from the decoder, copying at most OUT_BUF_SIZE bytes into
 * OUT_BUF (setting *OUTPUT_SIZE to the actual amount copied). */
extern "C" HSD_poll_res heatshrink_decoder_poll(heatshrink_decoder *hsd,
...
extern "C" HSD_finish_res heatshrink_decoder_finish(heatshrink_decoder *hsd);
